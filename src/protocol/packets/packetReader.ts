...
export type InPacket = PacketReader;
...
export class PacketReader {
    ...
    readByte(): number {
        // MapleStory bytes are unsigned (0..255); read as unsigned so values
        // like level 200 (0xC8) are not sign-extended to -56.
        const byte = this.data.readUIntLE(this.offset, 1);
        this.offset += 1;
        return byte;
    }
